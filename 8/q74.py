...
pred_y = predictor.predict()
print('学習データでの正解率：', accuracy(train_y, pred_y))

predictor = Predictor(model, gen_loader(val_dataset, 1))
pred_y = predictor.predict()
print('検証データでの正解率：', accuracy(val_y, pred_y))
